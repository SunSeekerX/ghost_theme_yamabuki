 ...
 * @LastEditTime: 2020-09-09 22:48:22
 */
...
/* harmony import */ var _utils_baidu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/baidu */ "./src/js/utils/baidu.js");
/* harmony import */ var _utils_comment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/comment */ "./src/js/utils/comment.js");
/**
 * @name:
 * @author: SunSeekerX
...
$(document).ready(() => {
  ...
  if (_config_index__WEBPACK_IMPORTED_MODULE_0__["default"].baiduTongji.open) {
    Object(_utils_baidu__WEBPACK_IMPORTED_MODULE_1__["initBaiduTongji"])();
  } // 评论


  if (_config_index__WEBPACK_IMPORTED_MODULE_0__["default"].valineOptions.open) {
    Object(_utils_comment__WEBPACK_IMPORTED_MODULE_2__["initValine"])(_config_index__WEBPACK_IMPORTED_MODULE_0__["default"].valineOptions);
  }
});

/***/ }),

/***/ "./src/js/utils/baidu.js":
/*!*******************************!*\
  !*** ./src/js/utils/baidu.js ***!
  \*******************************/
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ "./src/js/utils/index.js");
/**
 * @name:
 * @author: SunSeekerX
...
function initValine(valineOptions) {
  if ($('#vcomments').length !== 0) {
    if (typeof window.Valine === 'undefined') {
      Object(_index__WEBPACK_IMPORTED_MODULE_0__["loadScript"])('//unpkg.com/valine/dist/Valine.min.js', () => {
